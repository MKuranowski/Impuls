...
class TestTruncateCalendars(AbstractTestTask.Template):
    ...
    def test_truncates(self) -> None:
        ...
        self.assertListEqual(
            calendars,
            [
                ("Fri", 0, 0, 0, 0, 0, 0, 0, "1111-11-11", "1111-11-11", ""),
                ("Mon-Thu", 0, 0, 0, 0, 0, 0, 0, "1111-11-11", "1111-11-11", ""),
                ("Sat", 0, 0, 0, 0, 0, 0, 0, "1111-11-11", "1111-11-11", ""),
                ("Sun", 0, 0, 0, 0, 0, 0, 0, "1111-11-11", "1111-11-11", ""),
            ],
        )
